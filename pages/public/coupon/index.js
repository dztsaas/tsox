...
Page({
    ...
    getList: function() {
        for (var t = this, s = this.data, o = 0; o < s.goodslist.length; o++) delete s.goodslist[o].title, delete s.goodslist[o].optiontitle, delete s.goodslist[o].thumb;
