        ...
        t.get("member/bind", {}, function(t) {
            if (t.error) wx.redirectTo({
                ...
                a.postData = {
                    ...
                    password: "",
                    password1: ""
                }, i.setData(a), t.endtime > 0 && i.endTime(), e = t.binded ? "更换绑定手机号" : "绑定手机号", wx.setNavigationBarTitle({
                    title: e
                })
            }
        }, !0, !0, !0)
    ...
    submit: function(e) {
        if (!this.data.submit) {
            ...
            a.isMobile(o.mobile) ? 5 == o.code.length ? o.password && "" != o.password ? o.password1 && "" != o.password1 ? o.password == o.password1 ? (this.setData({
                ...
                if (92001 != e.error && 92002 != e.error) return 0 != e.error ? (i.toast(s, e.message), void s.setData({
                    submit: !1,
                    subtext: "立即绑定"
