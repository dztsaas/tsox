...
Page({
    ...
    play: function(e) {
        ...
        var c = s.data.audios;
        c[t] || (c[t] = {}), a.paused && 0 == n ? (a.src = r, a.play(), 1 == u && (a.loop = !0), c[t].status = !0, s.pauseOther(t)) : a.paused && n > 0 ? (a.play(), 0 == o ? a.seek(n) : a.seek(0), c[t].status = !0, s.pauseOther(t)) : (a.pause(), c[t].status = !1), s.setData({
            audios: c
        })
    },
