...
Page({
    ...
    getInfo: function() {
        ...
        e.get("member/withdraw", {}, function(e) {
            ...
            }), t.checked || (t.checked = t.objectArray[0], t.checkedIndex = 0), t.bankCheckedIndex = e.lastbankindex || 0, a.setData(t), e.withdrawmoney > 0 && e.credit >= e.withdrawmoney && (t.money = e.withdrawmoney, a.moneyChange({
                detail: {
    ...
    typeChange: function(a) {
        ...
        e.checked = this.data.objectArray[t], 3 == e.checked.id && (e.bankChecked = this.data.info.banklist[0], e.bankCheckedIndex = 0), this.setData(e)
    },
    ...
    submit: function(a) {
        var i = this,
            r = this.data;
        if (!r.disabled && !r.isSubmit) if (r.money <= 0) t.toast(i, "请填写提现金额");
            ...
            if (2 == r.checked.id) {
                ...
                o += "？姓名:" + r.realInfo.realname + " 支付宝帐号:" + r.realInfo.alipay, d.realname = r.realInfo.realname, d.alipay = r.realInfo.alipay, d.alipay1 = r.realInfo.alipay1
                ...
                o += "？姓名:" + r.realInfo.realname + " 银行:" + r.bankChecked.bankname + " 卡号:" + r.realInfo.bankcard, d.realname = r.realInfo.realname, d.bankname = r.bankChecked.bankname, d.bankcard = r.realInfo.bankcard, d.bankcard1 = r.realInfo.bankcard1
            }
            if (r.checked.id < 2) c = "确认要" + o + "？";
            else var c = "确认要" + o;
            r.info.withdrawcharge > 0 && (c += " 扣除手续费 " + r.deductionmoney + " 元,实际到账金额 " + r.realmoney + " 元"), e.confirm(c, function() {
                i.setData({
                    isSubmit: !0
