...
Page({
    data: (a = {
        ...
        num: [],
        clickCar: !1
    }, t(a, "num", 0), t(a, "change", !1), t(a, "div", !1), t(a, "numtotal", {}), t(a, "clearcart", !0), t(a, "canBuy", ""), t(a, "specs", []), t(a, "options", []), t(a, "diyform", {}), t(a, "specsTitle", ""), t(a, "total", 1), t(a, "active", ""), t(a, "slider", ""), t(a, "tempname", ""), t(a, "buyType", ""), t(a, "areas", []), t(a, "closeBtn", !1), t(a, "soundpic", !0), t(a, "closespecs", !1), t(a, "buyType", "cart"), t(a, "quickbuy", !0), t(a, "formdataval", {}), t(a, "showPicker", !1), a),
    onLoad: function(t) {
        wx.showLoading({
            title: "加载中..."
        });
        ...
        if (void 0 == a) {
            var i = getCurrentPages(),
                n = i[i.length - 1].route.split("/");
            a = n[n.length - 1]
        }
        var s = this,
            o = wx.getStorageSync("systemInfo");
        ...
        s.setData({
            ...
            var a = [],
                e = "";
            if (e = 1 == t.style.shopstyle ? "changeCss2" : 2 == t.style.shopstyle ? "changeCss3" : "", e += " " + t.style.logostyle, s.setData({
                main: t,
                group: t.group,
                goodsArr: t.goodsArr,
                arrCart: a,
                style: e
            }), o = 1 == s.data.main.cartdata ? s.data.pageid : "", s.data.main.advs) {
                if (s.data.main.advs.length > 0) var a = [198],
                    i = 198
            } else var a = [18],
                i = 18;
            for (var n = 0; n < s.data.main.group.length; n++) s.data.main.goodsArr[s.data.main.group[n].type] && (i = i + 106 * (s.data.main.goodsArr[s.data.main.group[n].type].length ? s.data.main.goodsArr[s.data.main.group[n].type].length : .6) + 66, a.push(i), s.setData({
                arrscroll: a
            }));
    ...
    addCartquick: function(t, a) {
        var e = this,
            i = e.data.numtotal,
            s = 1 == this.data.main.cartdata ? this.data.pageid : "";
        r.get("quick/index/update", {
            ...
            if (0 != t.error) e.setData({
                ...
                var a = e.data.main;
                a.cartList.total = t.total, a.cartList.totalprice = t.totalprice, a.cartList.list = [1], i[e.data.goodsid] = t.goodstotal, e.setData({
                    numtotal: i,
                    main: a,
                    clearcart: !0,
                    active: "",
    ...
    addGoodToCartFn: function(t) {
        e.checkAuth();
        var a = this,
            r = 1 == this.data.main.cartdata ? "takeoutmodel" : "shopmodel";
        t.currentTarget.dataset.canadd || (r = "cantaddcart"), a.setData({
            ...
            showPicker: !0,
            cycledate: !1
        }), i.selectpicker(t, a, "quickbuy", r)) : (a.setData({
    ...
    animate: function(t) {
        ...
        a.finger = {};
        var e = {};
        a.finger.x = t.touches[0].clientX, a.finger.y = t.touches[0].clientY, a.finger.y < a.busPos.y ? e.y = a.finger.y - 150 : e.y = a.busPos.y - 150, e.x = Math.abs(a.finger.x - a.busPos.x) / 2, a.finger.x > a.busPos.x ? e.x = (a.finger.x - a.busPos.x) / 2 + a.busPos.x : e.x = (a.busPos.x - a.finger.x) / 2 + a.finger.x, a.linePos = a.bezier([a.busPos, e, a.finger], 30), a.startAnimation(t)
    },
    bezier: function(t, a) {
        for (var e, r, i, n = [], s = 0; s <= a; s++) {
            for (i = t.slice(0), r = []; e = i.shift();) if (i.length) r.push(function(t, a) {
                var e, r, i, n, s, o, d, c;
                return e = t[0], r = t[1], n = r.x - e.x, s = r.y - e.y, i = Math.pow(Math.pow(n, 2) + Math.pow(s, 2), .5), o = s / n, d = Math.atan(o), c = i * a, {
                    x: e.x + c * Math.cos(d),
                    y: e.y + c * Math.sin(d)
                }
            }([e, i[0]], s / a));
    ...
    clearShopCartFn: function(t) {
        var a = this,
            e = 1 == this.data.main.cartdata ? this.data.pageid : "";
    ...
    cartaddcart: function(t) {
        var a = this,
            e = 1 == this.data.main.cartdata ? this.data.pageid : "",
            i = "0" == t.currentTarget.dataset.id ? t.currentTarget.dataset.goodsid : t.currentTarget.dataset.id,
            s = t.currentTarget.dataset.add;
        t.currentTarget.dataset.min == t.currentTarget.dataset.num && "reduce" == s && (s = "delete"), r.get("quick/index/update", {
            quickid: e,
    ...
    scrollfn: function(t) {
        for (var a = this, e = this.data.arrLab, r = 0; r < a.data.arrscroll.length; r++) if (e[r] = 0, Math.abs(t.detail.scrollTop - a.data.arrscroll[r]) < 26) {
            e[r] = 1, this.setData({
                arrLab: e
            });
            break
