...
var a = getApp(),
    o = a.requirejs("core"),
    t = (a.requirejs("jquery"), a.requirejs("foxui"), 0);
Page({
    data: {
        layershow: !1,
        chosenum: !1,
    ...
    joinTeam: function(a) {
        ...
        if (t.setData({
            ...
            op: ""
        }), "ladder" == e) d = t.data.data.id, o.get("groups.goods.goodsCheck", {
            id: d,
            type: "group"
        }, function(a) {
            0 == a.error ? t.setData({
        ...
        else if (0 == t.data.data.more_spec) d = t.data.data.id, o.get("groups.goods.goodsCheck", {
            id: d,
            type: "group"
        }, function(a) {
    ...
    specsTap: function(a) {
        ...
        var e = this,
            ...
            d = o.pdata(a).spedid,
            i = o.pdata(a).id,
            n = o.pdata(a).specindex;
        o.pdata(a).idx, s[n].item.forEach(function(a, o) {
            a.id == i ? s[n].item[o].status = "active" : s[n].item[o].status = ""
        }), e.setData({
            spec: s
        });
        var r = e.data.optionarr,
            p = e.data.selectSpecsarr;
        1 == t ? (r.push(i), p.push(d)) : p.indexOf(d) > -1 ? r.splice(n, 1, i) : (r.push(i), p.push(d)), e.data.optionarr = r, e.data.selectSpecsarr = p, o.post("groups.goods.get_option", {
