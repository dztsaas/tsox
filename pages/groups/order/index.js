...
var t = getApp(),
    e = t.requirejs("core"),
    a = (t.requirejs("jquery"), t.requirejs("biz/diyform"), t.requirejs("biz/goodspicker"), t.requirejs("foxui"), t.requirejs("biz/group_order"));
Page({
    data: {
        type_: "",
        page: 1,
