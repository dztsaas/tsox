...
var a = getApp(),
    t = a.requirejs("core"),
    o = (a.requirejs("jquery"), a.requirejs("foxui"), a.requirejs("wxParse/wxParse")),
    e = 0;
Page({
    data: {
        goods_id: 0,
    ...
    imageLoad: function(a) {
        var t = a.detail.height,
            o = a.detail.width,
            e = Math.floor(750 * t / o);
        t == o ? this.setData({
            advHeight: 750
        }) : this.setData({
            advHeight: e
    ...
    specsTap: function(a) {
        ...
        var o = this,
            ...
            i = t.pdata(a).spedid,
            n = t.pdata(a).id,
            d = t.pdata(a).specindex;
        t.pdata(a).idx, s[d].item.forEach(function(a, t) {
        ...
        1 == e ? (r.push(n), p.push(i)) : p.indexOf(i) > -1 ? r.splice(d, 1, n) : (r.push(n), p.push(i)), o.data.optionarr = r, o.data.selectSpecsarr = p, t.post("groups.goods.get_option", {
    ...
    buy: function(a) {
        var o = this,
            e = (t.pdata(a).op, o.data.goods_id),
            s = o.data.optiondata;
