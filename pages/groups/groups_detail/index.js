...
var a = getApp(),
    t = a.requirejs("core"),
    e = (a.requirejs("jquery"), a.requirejs("foxui"), 0),
    o = a.requirejs("wxParse/wxParse");
Page({
    data: {
        showtab: "groups",
        count_down: !0,
    ...
    get_details: function(a) {
        ...
        t.get("groups/team/details", {
            ...
            if (0 == a.error && (a.data.goods.content = a.data.goods.content.replace(/data-lazy/g, "src"), e.setData({
                data: a.data
    ...
    countDown: function(a, t, e) {
        var o = parseInt(Date.now() / 1e3),
            ...
            r = Math.floor((i - 24 * d * 60 * 60) / 3600),
            n = Math.floor((i - 24 * d * 60 * 60 - 3600 * r) / 60),
            u = Math.floor(i - 24 * d * 60 * 60 - 3600 * r - 60 * n);
    ...
    specsTap: function(a) {
        ...
        var o = this,
            ...
            i = t.pdata(a).spedid,
            d = t.pdata(a).id,
            r = t.pdata(a).specindex;
        t.pdata(a).idx, s[r].item.forEach(function(a, t) {
            a.id == d ? s[r].item[t].status = "active" : s[r].item[t].status = ""
        }), o.setData({
            spec: s
        });
        var n = o.data.optionarr,
            u = o.data.selectSpecsarr;
        1 == e ? (n.push(d), u.push(i)) : u.indexOf(i) > -1 ? n.splice(r, 1, d) : (n.push(d), u.push(i)), o.data.optionarr = n, o.data.selectSpecsarr = u, t.post("groups.goods.get_option", {
    ...
    buy: function(a) {
        var e = this,
            o = (t.pdata(a).op, e.data.data.goods.id),
            s = e.data.optiondata;
