...
var a, e, i = getApp(),
    ...
    c = (i.requirejs("foxui"), i.requirejs("jquery"));
Page((e = {
    ...
    data: (a = {
        ...
        diyform: {},
        specsTitle: ""
    }, t(a, "total", 1), t(a, "active", ""), t(a, "slider", ""), t(a, "tempname", ""), t(a, "buyType", ""), t(a, "areas", []), t(a, "closeBtn", !1), t(a, "soundpic", !0), t(a, "modelShow", !1), t(a, "limits", !0), t(a, "result", {}), t(a, "showcoupon", !1), t(a, "showcoupontips", !1), t(a, "topmenu", {}), t(a, "topmenuDataType", ""), t(a, "tabbarData", {}), t(a, "tabbarDataType", ""), t(a, "istopmenu", !1), t(a, "seckillinfo", {}), t(a, "timer", 0), t(a, "lasttime", 0), t(a, "hour", "-"), t(a, "min", "-"), t(a, "sec", "-"), a),
    getShop: function() {
        var t = this;
    ...
    getDiypage: function(t) {
        ...
        c.each(t.diypage.items, function(t, e) {
            ...
            if ("seckillgroup" == e.id) {
                var n = {};
                n.status = e.data.status, n.endtime = e.data.endtime, n.starttime = e.data.starttime, a.initSeckill(n)
            }
        })
    },
    onShareAppMessage: function() {
        var t = null,
            a = null;
        return this.data.diytitle && (t = "/pages/index/index", a = this.data.diytitle), s.onShareAppMessage(t, a)
    },
    ...
    "" != n && void 0 != n && s.get("diypage/getInfo", {
        ...
        for (var s in e.items) s == i && (e.items[s].data[o].data = t.goods.list, e.items[s].data[o].type = t.type, e.items[s].type = t.type, e.items[s].status = o, t.goods.list.length <= 8 && (e.items[s].data[o].showmore = !0), a.setData({
            diypages: e
        }))
    })
    ...
    c.each(i.items, function(t, n) {
        if (t == e) if (void 0 == n.status || "" == n.status) {
            ...
            s.get("diypage/getInfo", {
                ...
                n.data[0].data = t.goods.list, n.data[0].data.length == t.goods.count && (n.data[0].showmore = !0), a.setData({
                    diypages: i
                })
            })
        } else {
            ...
            s.get("diypage/getInfo", {
                ...
                n.data[n.status].data = t.goods.list, n.data[n.status].data.length == t.goods.count && (n.data[n.status].showmore = !0), a.setData({
                    diypages: i
                })
            })
        }
    ...
    var a = parseInt(t),
        e = 0,
        i = 0;
    return a > 60 && (e = parseInt(a / 60), a = parseInt(a % 60), e > 60 && (i = parseInt(e / 60), e = parseInt(e % 60))), {
        hour: i < 10 ? "0" + i : i,
        min: e < 10 ? "0" + e : e,
        sec: a < 10 ? "0" + a : a
    }
