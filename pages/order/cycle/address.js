...
Page({
    ...
    getDetail: function() {
        ...
        a.get("order/address", {
            ...
            if (!i.isEmptyObject(a.detail)) {
                ...
                var r = a.detail.province + " " + a.detail.city + " " + a.detail.area,
    ...
    submit: function() {
        var t = this,
            i = t.data.detail;
        t.data.posting || ("" != i.realname && i.realname ? "" != i.mobile && i.mobile ? "" != i.city && i.city ? !(t.data.street.length > 0) || "" != i.street && i.street ? "" != i.address && i.address ? i.datavalue ? (i.orderid = t.data.id, i.cycelid = t.data.cycelid, t.setData({
            posting: !0
    ...
    onChange: function(t) {
        ...
        "street" == r && (e.streetdatavalue = a.data.street[s].code, s = a.data.street[s].name), e[r] = s, a.setData({
            detail: e
        })
    },
    ...
    selectArea: function(t) {
        var a = t.currentTarget.dataset.area,
            e = this.getIndex(a, this.data.areas);
        this.setData({
            pval: e,
            pvalOld: e,
            showPicker: !0
    ...
    onConfirm: function(t) {
        var a = this.data.pval,
            e = this.data.areas,
            i = this.data.detail;
        i.province = e[a[0]].name, i.city = e[a[0]].city[a[1]].name, i.datavalue = e[a[0]].code + " " + e[a[0]].city[a[1]].code, e[a[0]].city[a[1]].area && e[a[0]].city[a[1]].area.length > 0 ? (i.area = e[a[0]].city[a[1]].area[a[2]].name, i.datavalue += " " + e[a[0]].city[a[1]].area[a[2]].code, this.getStreet(e, a)) : i.area = "", i.street = "", this.setData({
            detail: i,
            streetIndex: 0,
            showPicker: !1
        })
