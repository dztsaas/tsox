...
Page({
    ...
    number: function(t) {
        ...
        d.each(c.goods, function(t, e) {
            d.each(e.goods, function(e, a) {
                a.id == o && (c.goods[t].goods[e].total = s), n += parseInt(c.goods[t].goods[e].total), l += parseFloat(n * c.goods[t].goods[e].price)
            })
    ...
    caculate: function(t) {
        ...
        e.data.data && 0 != e.data.data.couponid && (a = e.data.data.couponid), i.post("order/create/caculate", {
            ...
            console.error(a), t.dispatch_price = a.price, t.enoughdeduct = a.deductenough_money, t.enoughmoney = a.deductenough_enough, t.taskdiscountprice = a.taskdiscountprice, t.discountprice = a.discountprice, t.isdiscountprice = a.isdiscountprice, t.seckill_price = a.seckill_price, t.deductcredit2 = a.deductcredit2, t.deductmoney = a.deductmoney, t.deductcredit = a.deductcredit, t.gifts = a.gifts, e.data.data.deduct && (a.realprice -= a.deductmoney), e.data.data.deduct2 && (a.realprice -= a.deductcredit2), e.data.coupon && void 0 !== e.data.coupon.deductprice && (e.setData({
                "coupon.deductprice": a.coupon_deductprice
            }), a.realprice -= a.coupon_deductprice), a.card_info && (t.card_free_dispatch = a.card_free_dispatch), 0 == e.data.goods.giftid && e.setData({
                "goods.gifts": a.gifts
            }), t.realprice <= 0 && (t.realprice = 1e-6), t.realprice = d.toFixed(a.realprice, 2), e.setData({
                list: t,
    ...
    dataChange: function(t) {
        ...
        switch (t.target.id) {
            ...
            case "deduct":
                ...
                i = parseFloat(a.realprice), i += e.deduct ? -parseFloat(a.deductmoney) : parseFloat(a.deductmoney), a.realprice = i;
                break;
            case "deduct2":
        ...
        a.realprice <= 0 && (a.realprice = 1e-6), a.realprice = d.toFixed(a.realprice, 2), this.setData({
            data: e,
            list: a
        })
    },
    ...
    onChange2: function(t) {
        ...
        "street" == i && (a.streetdatavalue = e.data.street[r].code, r = e.data.street[r].name), a[i] = r, e.setData({
            "areaDetail.detail": a
        })
    },
    ...
    submitaddress: function() {
        ...
        t.data.posting || ("" != e.realname && e.realname ? "" != e.mobile && e.mobile ? "" != e.city && e.city ? !(t.data.street.length > 0) || "" != e.street && e.street ? "" != e.address && e.address ? e.datavalue ? (e.id = 0, t.setData({
            posting: !0
    ...
    clearform: function() {
        ...
        d.each(t, function(a, i) {
            d.each(i, function(a, i) {
                5 == i.data_type && (t.f_data[i.diy_type].count = 0, t.f_data[i.diy_type].images = [], e[i.diy_type] = t.f_data[i.diy_type])
            })
    ...
    showinvoicepicker: function() {
        ...
        0 == t.invoice_type && (t.invoice_info.entity = !0), 1 == t.invoice_type && (t.invoice_info.entity = !1), this.setData({
            invoicepicker: !0,
            list: t
        })
    },
    ...
    chaninvoice: function(t) {
        var e = this.data.list;
        "0" == t.currentTarget.dataset.type ? e.invoice_info.entity = !1 : e.invoice_info.entity = !0, this.setData({
            list: e
        })
    },
    changeType: function(t) {
        var e = this.data.list;
        "0" == t.currentTarget.dataset.type ? e.invoice_info.company = !1 : e.invoice_info.company = !0, this.setData({
            list: e
        })
    },
