...
Page({
    ...
    reDatelist: function(t) {
        var e = this,
            a = t.currentTarget.dataset.year,
            r = t.currentTarget.dataset.month;
        e.setData({
            yearShow: a,
            monthShow: r,
            dateHidden: 1
    ...
    oldSign: function(t) {
        var e = this,
            a = t.currentTarget.dataset.date;
    ...
    dosign: function(e) {
        ...
        t.post("zy/sign/dosign", {
            ...
            t.alert(e.message), a.getList(), e.lottery && e.lottery.is_changes > 0 && (t.alert("您获得抽奖机会"), setTimeout(function() {
                wx.redirectTo({
