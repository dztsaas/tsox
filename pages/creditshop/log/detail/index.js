    ...
    getDetail: function() {
        ...
        o.get("creditshop/log/detail", s, function(a) {
            if (0 == a.error) {
                ...
                }, e(i, "log", a.log), e(i, "replyset", a.set), e(i, "ordercredit", a.ordercredit), e(i, "ordermoney", a.ordermoney), e(i, "address", a.address), e(i, "carrier", a.carrier), e(i, "shop", a.shop), e(i, "allmoney", r), e(i, "verify", a.verify), i));
                var n = 0;
