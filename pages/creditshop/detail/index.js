...
t.requirejs("jquery"), Page({
    ...
    getDetail: function() {
        ...
        o.get("creditshop/detail", {
            ...
            if (e.wxParse("wxParseData", "html", o.goods.goodsdetail, t, "0"), e.wxParse("wxParseData_subdetail", "html", o.goods.subdetail, t, "0"), e.wxParse("wxParseData_noticedetail", "html", o.goods.noticedetail, t, "0"), e.wxParse("wxParseData_usedetail", "html", o.goods.usedetail, t, "0"), t.setData({
                goods: o.goods,
                log: o.log,
                logmore: o.logmore,
                replays: o.replys,
    ...
    countDown: function(t, o) {
        var a = parseInt(Date.now() / 1e3),
            ...
            d = Math.floor((s - 24 * i * 60 * 60 - 3600 * n) / 60),
            r = {
                day: i,
                hour: n,
                minute: d,
    ...
    specselect: function(t) {
        var o = this,
            e = o.data.selectspecs,
            s = t.target.dataset.idx,
            i = t.target.dataset.specid;
        e[s] = {
            id: i,
    ...
    openActionSheet: function() {
        var t = this,
            o = t.data.goods.canbuy,
            a = t.data.goods.hasoption,
            e = t.data.optionid;
