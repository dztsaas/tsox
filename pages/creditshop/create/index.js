...
t.requirejs("wxParse/wxParse"), t.requirejs("jquery"), Page({
    ...
    onShow: function() {
        var e = this,
            a = t.getCache("isIpx"),
            s = t.getCache("orderAddress"),
            o = t.getCache("orderShop");
        o && e.setData({
            carrierInfo: o
        }), e.data.addressid, s.id > 0 && (e.addressid = s.id, e.setData({
            addressid: s.id
    ...
    getDetail: function() {
        ...
        e.get("creditshop/create", a, function(a) {
            0 == a.error && (a.goods.num = 1, t.setData({
                goods: a.goods,
                address: a.address,
                shop: a.shop,
                stores: a.stores,
    ...
    number: function(t) {
        ...
        "minus" == d ? o.num = parseInt(o.num) - 1 : "plus" == d && (o.num = parseInt(o.num) + 1), o.num < 1 && (o.num = 1);
        var r = o.num;
    ...
    lottery: function() {
        ...
        0 == t.data.goods.type ? e.get("creditshop/detail/lottery", {
            ...
            e.error > 0 ? a.toast(t, e.message) : (2 == e.status && (s = "恭喜您，商品兑换成功"), 3 == e.status && (1 == e.goodstype ? s = "恭喜您，优惠券兑换成功" : 2 == e.goodstype ? s = "恭喜您，余额兑换成功" : 3 == e.goodstype && (s = "恭喜您，红包兑换成功")), t.setData({
                successmessage: s,
                successstatus: !0
            }))
            ...
            e.get("creditshop/detail/lottery", {
                ...
                e.error > 0 ? a.toast(t, e.message) : (2 == e.status ? s = "恭喜您，您中奖啦" : 3 == e.status ? 1 == e.goodstype ? s = "恭喜您，优惠券已经发到您账户啦" : 2 == e.goodstype ? s = "恭喜您，余额已经发到您账户啦" : 3 == e.goodstype && (s = "恭喜您，红包兑换成功") : s = "很遗憾，您没有中奖", t.setData({
                    successmessage: s,
                    successstatus: !0
                }))
            })
