...
var t = getApp(),
    i = t.requirejs("core"),
    a = (t.requirejs("jquery"), t.requirejs("foxui"), t.requirejs("wxParse/wxParse"));
Page({
    data: {
        id: "",
        layer: !1,
    ...
    imageLoad: function(t) {
        var i = t.detail.height,
            a = t.detail.width,
            e = Math.floor(750 * i / a);
        i == a ? this.setData({
            advHeight: 750
        }) : this.setData({
            advHeight: e
    ...
    onLoad: function(e) {
        ...
        t.getCache("isIpx") ? r.setData({
            ...
            }), a.wxParse("wxParseData", "html", t.list.content, r, "0"), r.countDown(t.list.start_time, t.list.end_time, "istime"), 1 == t.list.isStart) {
    ...
    countDown: function(t, i, a) {
        var e = parseInt(Date.now() / 1e3),
            ...
            h = [n, o, l, Math.floor(s - 24 * n * 60 * 60 - 3600 * o - 60 * l)];
        if (this.setData({
            time: h
        }), "istime") {
            var u = "";
