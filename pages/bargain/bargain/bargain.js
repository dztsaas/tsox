...
var a = getApp(),
    t = a.requirejs("core"),
    i = (a.requirejs("jquery"), a.requirejs("foxui"), a.requirejs("wxParse/wxParse"));
Page({
    data: {
            ...
            if (1 != a.error) {
                if (0 == a.error) {
                    1 == a.unequalMid && wx.navigateTo({
                        ...
                        arrived: a.arrived,
                        timeout: a.timeout
                    }), i.wxParse("wxParseData", "html", a.bargain.content, e, "0"), "" == a.bargain.rule || void 0 == a.bargain.rule ? i.wxParse("wxParseDataRule", "html", a.bargain_set.rule, e, "0") : i.wxParse("wxParseDataRule", "html", a.bargain.rule, e, "0"), e.countDown(a.bargain.start_time, a.bargain.end_time, "istime"), clearInterval(e.data.timer);
    ...
    cutPrice: function() {
        a.checkAuth();
        var i = "/pages/message/auth/index",
            r = this,
            e = r.data.bargainid,
            s = r.data.mid;
    ...
    countDown: function(a, t, i) {
        var r = parseInt(Date.now() / 1e3),
            ...
            d = Math.floor((s - 24 * n * 60 * 60 - 3600 * o) / 60),
            g = [n, o, d, Math.floor(s - 24 * n * 60 * 60 - 3600 * o - 60 * d)];
        if (this.setData({
            time: g
        }), "istime") {
            var u = "";
    ...
    onShareAppMessage: function(a) {
        ...
        return {
            title: "帮砍价",
            path: "/pages/bargain/bargain/bargain?id=" + t.data.bargainid + "&mid=" + t.data.mid,
            success: function(a) {},
            fail: function(a) {}
        }
    }
