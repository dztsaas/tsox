...
var e, a, o = getApp(),
    i = o.requirejs("core"),
    s = (o.requirejs("icons"), o.requirejs("foxui")),
...
Page((a = {
    data: (e = {
        ...
        modelShow: !1,
        showgoods: !0
    }, t(e, "timer", 0), t(e, "lasttime", 0), t(e, "hour", "-"), t(e, "min", "-"), t(e, "sec", "-"), t(e, "currentDate", ""), t(e, "dayList", ""), t(e, "currentDayList", ""), t(e, "currentObj", ""), t(e, "currentDay", ""), t(e, "checkedDate", ""), t(e, "showDate", ""), t(e, "scope", ""), t(e, "goods_hint_show", !1), t(e, "presellisstart", 0), t(e, "advHeight", 1), e),
    ...
    onReachBottom: function() {
        ...
        var e = t.data.commentObjTab,
            a = "";
        1 == e ? a = "all" : 2 == e ? a = "good" : 3 == e ? a = "normal" : 4 == e ? a = "bad" : 5 == e && (a = "pic"), t.setData({
            loading: !0
        }), i.get("goods/get_comment_list", {
    ...
    comentTap: function(t) {
        var e = this,
            ...
            o = "";
        1 == a ? (o = "all", e.data.commentPage = 1) : 2 == a ? (e.data.commentPage = 1, o = "good") : 3 == a ? (e.data.commentPage = 1, o = "normal") : 4 == a ? (e.data.commentPage = 1, o = "bad") : 5 == a && (e.data.commentPage = 1, o = "pic"), a != e.data.commentObjTab && i.get("goods/get_comment_list", {
            id: e.data.options.id,
            level: o,
            page: e.data.commentPage
        }, function(t) {
    ...
    getDetail: function(t) {
        ...
        e.setData({
            ...
            if (t.goods.thumbMaxWidth, e.setData({
                ...
                scope: t.goods.scope
            }), t.goods.packagegoods && e.package(), l.wxParse("wxParseData", "html", t.goods.content, e, "0"), l.wxParse("wxParseData_buycontent", "html", t.goods.buycontent, e, "0"), e.setData({
                show: !0,
                goods: t.goods,
                ...
                dispatchpriceObj: 1
            }), t.goods.isdiscount > 0 && t.goods.isdiscount_time >= a ? (clearInterval(e.data.timer), n = setInterval(function() {
            ...
            if (void 0 != r) {
                var c = r.maxfullbackratio,
                    g = r.maxallfullbackallratio,
                    c = Math.round(c),
                    g = Math.round(g);
                e.setData({
                    maxfullbackratio: c,
    ...
    initSeckill: function(t) {
        var e = this,
            ...
            i = t.seckillinfo.starttime,
            s = t.seckillinfo.endtime;
        if (-1 != a) {
            var n = 0,
                r = 0,
            ...
            wx.request({
                ...
                success: function(o) {
                    ...
                    n = 0 == a ? s - c : i - c, e.setData({
                        lasttime: n
                    }), clearInterval(e.data.timer), e.setTimer(t.seckillinfo), r = e.setTimerInterval(t.seckillinfo), e.setData({
                        timer: r
                    })
                }
            })
    ...
    formatSeconds: function(t) {
        var e = parseInt(t),
            a = 0,
            o = 0;
        return e > 60 && (a = parseInt(e / 60), e = parseInt(e % 60), a > 60 && (o = parseInt(a / 60), a = parseInt(a % 60))), {
            hour: o < 10 ? "0" + o : o,
            min: a < 10 ? "0" + a : a,
            sec: e < 10 ? "0" + e : e
        }
    ...
    countDown: function(t, e, a) {
        var o = parseInt(Date.now() / 1e3),
            ...
            r = Math.floor((s - 24 * n * 60 * 60) / 3600),
            c = Math.floor((s - 24 * n * 60 * 60 - 3600 * r) / 60),
            d = [n, r, c, Math.floor(s - 24 * n * 60 * 60 - 3600 * r - 60 * c)];
        if (this.setData({
            time: d
        }), "istime") {
            var l = "";
    ...
    selectPicker: function(t) {
        ...
        var e = this,
            ...
            i = t.currentTarget.dataset.timeout;
        if (e.data.limits) {
            if ("timeout" == a || "access_time" == a) {
                ...
                if ("true" == i) {
                    if ("access_time" == a) return e.setData({
                        goods_hint_show: !1
                    }), s = "goodsdetail", void c.selectpicker(t, e, s);
    ...
    play: function(t) {
        ...
        var d = i.data.audios;
        d[e] || (d[e] = {}), a.paused && 0 == n ? (a.src = s, a.play(), 1 == c && (a.loop = !0), d[e].status = !0, i.pauseOther(e)) : a.paused && n > 0 ? (a.play(), 0 == r ? a.seek(n) : a.seek(0), d[e].status = !0, i.pauseOther(e)) : (a.pause(), d[e].status = !1), i.setData({
            audios: d
        })
    },
