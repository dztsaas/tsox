...
t.requirejs("foxui"), Page({
    ...
    getList: function() {
        ...
        t.setData({
            ...
            e.list || (e.list = []), e.list.length > 0 && (a.page = t.data.page + 1, a.list = t.data.list.concat(e.list), e.list.length < e.pagesize && (a.loaded = !0)), t.setData(a)
        })
    },
    changeMode: function() {
    ...
    bindSort: function(t) {
        ...
        if ("" == e) {
            ...
            listorder: ""
        }), a.order == e ? "desc" == a.by ? a.by = "asc" : a.by = "desc" : a.by = "asc", a.order = e, this.setData({
            listorder: a.by
        });
        else if ("sales" == e) {
            if (a.order == e) return;
