...
var t = getApp(),
    o = t.requirejs("core"),
    a = (t.requirejs("icons"), t.requirejs("jquery"), t.requirejs("foxui"));
Page({
    data: {
        show: !0,
        option_mask: !1
    ...
    option: function(t) {
        var a = this,
            i = t.currentTarget.dataset.goodsid,
    ...
    choose: function(t) {
        var o = t.currentTarget.dataset.optionid,
            a = t.currentTarget.dataset.title,
            i = t.currentTarget.dataset.index,
            e = this.data.packgoods,
            n = this.data.option[i].packageprice;
    ...
    confirm: function() {
        var t = this.data.packgoods,
            o = this.data.index,
            a = this.data.option_active,
            i = this.data.option_title,
            e = this.data.good;
