...
Page({
    ...
    getData: function() {
        ...
        t.get("commission/apply", {}, function(n) {
            ...
            }, 2e3)) : (n.show = !0, e.isArray(n.last_data) && (n.last_data = {}), n.last_data && (n.last_data.alipay1 = n.last_data.alipay, n.last_data.bankcard1 = n.last_data.bankcard), n.bankIndex = n.bankIndex || 0, a.setData(n))
        }, !1, !0)
    },
    ...
    submit: function(a) {
        ...
        if (s.cansettle && !s.isSubmit) {
            if (0 == s.applytype) r = "提现到余额";
            else if (1 == s.applytype) r = "提现到微信钱包";
            else if (2 == s.applytype) r = "提现到支付宝";
            else if (3 == s.applytype) var r = "提现到银行卡";
            var l = {
                type: s.applytype
            };
            if (2 == s.applytype) {
                ...
                r += "？姓名:" + s.last_data.realname + " 支付宝帐号:" + s.last_data.alipay, l.realname = s.last_data.realname, l.alipay = s.last_data.alipay, l.alipay1 = s.last_data.alipay1
                ...
                r += "？姓名:" + s.last_data.realname + " 银行:" + s.banklist[s.bankIndex].bankname + " 卡号:" + s.last_data.bankcard, l.realname = s.last_data.realname, l.bankname = s.banklist[s.bankIndex].bankname, l.bankcard = s.last_data.bankcard, l.bankcard1 = s.last_data.bankcard1
            }
            e = s.applytype < 2 ? "确认要" + r + "？" : "确认要" + r, s.set_array.charge > 0 && (e += " 扣除手续费 " + s.deductionmoney + " 元,实际到账金额 " + s.realmoney + " 元"), t.confirm(e, function() {
                i.setData({
                    isSubmit: !0
