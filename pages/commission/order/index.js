...
Page({
    ...
    getList: function() {
        ...
        t.get("commission/order/get_list", {
            ...
            delete t.error;
            var e = t;
            e.show = !0, t.list.length > 0 && (e.page = a.data.page + 1, e.list = a.data.list.concat(t.list), t.list.length < t.pagesize && (e.loaded = !0)), a.setData(e), wx.setNavigationBarTitle({
                title: t.textorder
            })
        }, this.data.show)
    },
