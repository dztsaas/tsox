...
Page((e = {
    ...
    var u = s.data.audios;
    u[a] || (u[a] = {}), e.paused && 0 == n ? (e.src = o, e.play(), 1 == d && (e.loop = !0), u[a].status = !0, s.pauseOther(a)) : e.paused && n > 0 ? (e.play(), 0 == r ? e.seek(n) : e.seek(0), u[a].status = !0, s.pauseOther(a)) : (e.pause(), u[a].status = !1), s.setData({
        audios: u
    })
    ...
    "" != o && void 0 != o && s.get("diypage/getInfo", {
        ...
        for (var s in e.items) s == i && (e.items[s].data[n].data = t.goods.list, e.items[s].data[n].type = t.type, e.items[s].type = t.type, e.items[s].status = n, t.goods.list.length <= 8 && (e.items[s].data[n].showmore = !0), a.setData({
            diypages: e
        }))
    })
    ...
    u.each(i.items, function(t, o) {
        if (t == e) if (void 0 == o.status || "" == o.status) {
            ...
            s.get("diypage/getInfo", {
                ...
                o.data[0].data = t.goods.list, o.data[0].data.length == t.goods.count && (o.data[0].showmore = !0), a.setData({
                    diypages: i
                })
            })
        } else {
            ...
            s.get("diypage/getInfo", {
                ...
                o.data[o.status].data = t.goods.list, o.data[o.status].data.length == t.goods.count && (o.data[o.status].showmore = !0), a.setData({
                    diypages: i
                })
            })
        }
