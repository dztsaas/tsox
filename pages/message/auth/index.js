            ...
            success: function(a) {
                t.post("wxapp/login", {
                    ...
                    a.error ? t.alert("获取用户登录态失败:" + a.message) : t.get("wxapp/auth", {
                        ...
                        }), n.detail.userInfo.openid = t.openId, n.detail.userInfo.id = t.id, n.detail.userInfo.uniacid = t.uniacid, e.setCache("userinfo", n.detail.userInfo), e.setCache("userinfo_openid", n.detail.userInfo.openid), e.setCache("userinfo_id", t.id), e.getSet(), wx.reLaunch({
                            url: c
                        })
                    })
                })
