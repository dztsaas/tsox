...
function r(e, a, i, r) {
    ...
    if (o && 0 != o.images.length) {
        var s = o.images,
            g = n(e.detail.width, e.detail.height, i, r),
            l = s[a].index,
            h = "" + r,
            m = !0,
            u = !1,
...
function n(e, t, a, i) {
    var r = 0,
        n = 0,
        d = 0,
        o = {}, l = a.data[i].view.imagePadding;
    return r = s - 2 * l, e > r ? (d = (n = r) * t / e, o.imageWidth = n, o.imageheight = d) : (o.imageWidth = e, o.imageheight = t), (s <= 0 || g <= 0) && wx.getSystemInfo({
        success: function(t) {
