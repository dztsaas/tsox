/*   time:2019-04-21 23:06:49*/
var t = getApp(),
    a = (t.requirejs("jquery"), t.requirejs("core")),
    e = t.requirejs("foxui"),
...
module.exports = {
    number: function(t, o) {
        var i = a.pdata(t),
            d = e.number(o, t),
            s = (i.id, i.optionid, i.min);
        i.max, 1 == d && 1 == i.value && "minus" == t.target.dataset.action || d < s && "minus" == t.target.dataset.action ? e.toast(o, "单次最少购买" + i.value + "件") : i.value == i.max && "plus" == t.target.dataset.action || (parseInt(o.data.stock) < parseInt(d) ? e.toast(o, "库存不足") : o.setData({
            total: d
        }))
    },
    inputNumber: function(t, a) {
        var o = a.data.goods.maxbuy,
            i = a.data.goods.minbuy,
            d = t.detail.value;
        if (d > 0) {
            if (o > 0 && o <= parseInt(t.detail.value) && (d = o, e.toast(a, "单次最多购买" + o + "件")), i > 0 && i > parseInt(t.detail.value) && (d = i, e.toast(a, "单次最少购买" + i + "件")), parseInt(a.data.stock) < parseInt(d)) return void e.toast(a, "库存不足")
        } else d = i > 0 ? i : 1;
        a.setData({
            total: d
        })
    ...
    buyNow: function(t, i, d) {
        ...
        var s = i.data.optionid,
            r = i.data.goods.hasoption,
            n = i.data.diyform,
            g = i.data.giftid;
        if (9 == i.data.goods.type) var l = i.data.checkedDate / 1e3;
        if (r > 0 && !s) e.toast(i, "请选择规格");
            ...
            a.post("order/create/diyform", {
                ...
                }) : "" != g ? (i.data.goods.giftinfo && 1 == i.data.goods.giftinfo.length && (g = i.data.goods.giftinfo[0].id), i.data.goods.gifts && 1 == i.data.goods.gifts.length && (g = i.data.goods.gifts[0].id), wx.redirectTo({
                    url: "/pages/order/create/index?id=" + i.data.id + "&total=" + i.data.total + "&optionid=" + s + "&gdid=" + t.gdid + "&giftid=" + g
                })) : e.toast(i, "请选择赠品")
            })
        ...
        }) : "" != g ? (i.data.goods.giftinfo && 1 == i.data.goods.giftinfo.length && (g = i.data.goods.giftinfo[0].id), i.data.goods.gifts && 1 == i.data.goods.gifts.length && (g = i.data.goods.gifts[0].id), wx.navigateTo({
            url: "/pages/order/create/index?id=" + i.data.id + "&total=" + i.data.total + "&optionid=" + s + "&giftid=" + g
        })) : e.toast(i, "请选择赠品")
    },
    getCart: function(t, i) {
        var d = i.data.optionid,
            s = i.data.goods.hasoption,
            r = i.data.diyform;
        if (s > 0 && !d) e.toast(i, "请选择规格");
        else if (i.data.quickbuy) {
    ...
    selectpicker: function(o, i, d, s) {
        ...
        "" == r && i.setData({
            ...
            if (t.goods.presellstartstatus || void 0 == t.goods.presellstartstatus || "1" != t.goods.ispresell) if (t.goods.presellendstatus || void 0 == t.goods.presellstartstatus || "1" != t.goods.ispresell) {
                ...
                if ("goodsdetail" == d) i.setData({
                ...
                }), r = 0 != t.goods.minbuy && i.data.total < t.goods.minbuy ? t.goods.minbuy : i.data.total;
                else if (i.setData({
                    pickerOption: t,
                    goods: t.goods,
                    options: a,
                    ...
                    specsData: [],
                    specs: []
                }), 0 != t.goods.minbuy && i.data.total < t.goods.minbuy) r = t.goods.minbuy;
                else var r = 1;
                t.diyform && i.setData({
                    diyform: {
            ...
            } else e.toast(i, t.goods.presellstatustitle);
            else e.toast(i, t.goods.presellstatustitle)
        })
    },
