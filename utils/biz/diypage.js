                    ...
                    if (t.each(i.diypage.items, function(t, o) {
                        if (s.push(o.id), "topmenu" == o.id) {
                            ...
                            e.setData({
                                ...
                                o.data[0].data = t.goods.list, p.diypages = i.diypage, p.topmenuDataType = t.type, e.setData(p)
                            }))
                        } else if ("tabbar" == o.id) if (void 0 == o.data[0]) g = "";
                        else {
                            var g = o.data[0].linkurl;
                            a.get("diypage/getInfo", {
                                dataurl: g
                            }, function(t) {
                                o.data[0].data = t.goods.list, o.type = t.type, p.diypages = i.diypage, p.tabbarDataType = t.type, p.tabbarData = t.goods, e.setData(p)
                            })
                        }
