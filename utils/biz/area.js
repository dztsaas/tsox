        ...
        for (var t in e.areas.province) if (0 != t) {
            ...
            for (var n in e.areas.province[t].city) if (0 != n) {
                ...
                for (var o in e.areas.province[t].city[n].county) {
                    if (e.areas.province[t].city[n].county[o].hasOwnProperty("@attributes")) s = e.areas.province[t].city[n].county[o]["@attributes"].name;
                    else var s = e.areas.province[t].city[n].county[o].name;
                    c.push(s)
                }
                i.push({
                    city_name: c
