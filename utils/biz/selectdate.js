...
module.exports = {
    ...
    setSchedule: function(t) {
        ...
        if (1 == t.data.isdelay) {
            var g = [1, 7, 30],
                D = [],
                l = (D = t.data.cycelbuy_periodic.split(","))[0] * g[D[1]],
                y = t.data.period_index;
            0 == y && (y = 1);
            var h = D[2] - y + 1
        }
        for (var f = t.data.maxday, v = t.data.initDate, p = t.data.checkedDate, k = 0; k < 42; k++) {
            ...
            if (k < c - 1) u[k] = {
                ...
                var Y = !1,
                    j = !1,
                    w = Date.parse(s.y + "/" + s.m + "/" + s.d);
                w < v && (Y = !0), 1 == t.data.isdelay && (w - p) % (864e5 * l) == 0 && w < p + h * l * 864e5 && w > p && (j = !0), w > v + 864e5 * (f - 1) && (Y = !0), w == p && (Y = !1, j = !0), u[k] = {
                    id: i + 1,
                    week: o[b],
                    no_optional: Y,
                    checked: j
