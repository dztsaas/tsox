...
module.exports = {
    ...
    onConfirm: function(a, e) {
        var t = a.data.pval,
            ...
            n = r.isEmptyObject(a.data.diyform.f_data) ? {} : a.data.diyform.f_data,
            d = a.data.areas;
        if (n[i] = n[i] || {}, n[i].province = d[t[0]].name, n[i].city = d[t[0]].city[t[1]].name, a.data.areaKey) {
            var f = a.data.areaDetail[a.data.areaKey];
            f.province = d[t[0]].name, f.city = d[t[0]].city[t[1]].name
        }
        if (a.data.noArea || (n[i].area = d[t[0]].city[t[1]].area[t[2]].name, a.data.areaKey && (f.area = d[t[0]].city[t[1]].area[t[2]].name)), a.setData({
            "diyform.f_data": n,
            showPicker: !1,
            bindAreaField: !1
        }), a.data.areaKey) {
    ...
    selectArea: function(a, e) {
        var t = e.currentTarget.dataset.area,
            ...
            d = e.currentTarget.dataset.areakey,
            f = {
                pval: n,
                pvalOld: n,
                showPicker: !0,
    ...
    DiyFormHandler: function(a, t) {
        var n = t.target.dataset,
            ...
            f = n.field,
            o = n.datatype,
            s = a.data.diyform.f_data;
        (r.isArray(s) || "object" != (void 0 === s ? "undefined" : e(s))) && (s = {});
        var m = a.data.diyform.fields;
        if ("input" == d || "textarea" == d || "checkbox" == d || "date" == d || "datestart" == d || "dateend" == d || "time" == d || "timestart" == d || "timeend" == d || "radio" == d) if ("datestart" == d || "timestart" == d) r.isArray(s[f]) || (s[f] = []), s[f][0] = t.detail.value;
        else if ("dateend" == d || "timeend" == d) r.isArray(s[f]) || (s[f] = []), s[f][1] = t.detail.value;
        else if ("checkbox" == d) {
            s[f] = {};
        ...
        } else "radio" == d ? s[f] = t.detail.value : 10 == o ? (r.isEmptyObject(s[f]) && (s[f] = {}), s[f][n.name] = t.detail.value) : s[f] = t.detail.value;
        else if ("picker" == d) {
    ...
    verify: function(a, e) {
        for (var t in e.fields) {
            ...
            if (1 == i.tp_must) if (5 == i.data_type) {
                if (!e.f_data[d] || e.f_data[d].count < 1) return n.toast(a, "请选择" + i.tp_name), !1
            } else if (9 == i.data_type) {
                if (r.isEmptyObject(e.f_data[d]) || !e.f_data[d].province || !e.f_data[d].city) return n.toast(a, "请选择" + i.tp_name), !1
            } else if (10 == i.data_type) {
                if (r.isEmptyObject(e.f_data[d]) || !e.f_data[d].name1) return n.toast(a, "请填写" + i.tp_name), !1;
                if (!e.f_data[d].name2 || "" == e.f_data[d].name2) return n.toast(a, "请填写" + i.tp_name2), !1
            } else if (11 == i.data_type) {
                if (!e.f_data[d]) return n.toast(a, "请填写" + i.tp_name), !1
            } else if (!e.f_data[d]) return n.toast(a, "请填写" + i.tp_name), !1;
            if (6 == i.data_type && !/(^\d{15}$)|(^\d{18}$)|(^\d{17}(\d|X|x)$)/.test(e.f_data[d])) return n.toast(a, "请填写正确的" + i.tp_name), !1;
            if (10 == i.data_type && (r.isEmptyObject(e.f_data[d]) || e.f_data[d].name1 != e.f_data[d].name2)) return n.toast(a, i.tp_name + "与" + i.tp_name2 + "不一致"), !1
        }
        return !0
    }
};