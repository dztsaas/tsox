...
function n(t, r, o, i) {
    ...
    else if (o || "object" !== p.type(r)) i(t, r);
    else for (u in r) n(t + "[" + u + "]", r[u], o, i)
}
function t(n) {
    var t = n.length,
        r = p.type(n);
    ...
    p = {
        ...
        each: function(n, r, e) {
            var o = 0,
                ...
                u = t(n);
            if (e) {
                if (u) for (; o < i && !1 !== r.apply(n[o], e); o++);
                else for (o in n) if (!1 === r.apply(n[o], e)) break
            } else if (u) for (; o < i && !1 !== r.call(n[o], o, n[o]); o++);
            else for (o in n) if (!1 === r.call(n[o], o, n[o])) break;
            return n
        },
        ...
        makeArray: function(n, r) {
            var e = r || [];
            return null != n && (t(Object(n)) ? p.merge(e, "string" == typeof n ? [n] : n) : u.call(e, n)), e
        },
        ...
        merge: function(n, t) {
            var r = t.length,
                e = n.length,
                o = 0;
            if ("number" == typeof r) for (; o < r; o++) n[e++] = t[o];
            else for (; void 0 !== t[o];) n[e++] = t[o++];
            return n.length = e, n
        },
        isMobile: function(n) {
...
p.extend = function() {
    var n, t, r, o, i, u, f = arguments[0] || {}, c = 1,
        a = arguments.length,
        l = !1;
    for ("boolean" == typeof f && (l = f, f = arguments[1] || {}, c = 2), "object" === (void 0 === f ? "undefined" : e(f)) || p.isFunction(f) || (f = {}), a === c && (f = this, --c); c < a; c++) if (null != (n = arguments[c])) for (t in n) r = f[t], f !== (o = n[t]) && (l && o && (p.isPlainObject(o) || (i = p.isArray(o))) ? (i ? (i = !1, u = r && p.isArray(r) ? r : []) : u = r && p.isPlainObject(r) ? r : {}, f[t] = p.extend(l, u, o)) : void 0 !== o && (f[t] = o));
    return f
