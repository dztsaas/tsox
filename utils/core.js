...
module.exports = {
    ...
    getUrl: function(t, o, i) {
        ...
        return o && ("object" == (void 0 === o ? "undefined" : e(o)) ? a += "&" + n.param(o) : "string" == typeof o && (a += "&" + o)), a
    },
    json: function(t, e, o, i, a, r) {
        ...
        (e = e || {}).comefrom = "wxapp", e.openid = "sns_wa_" + c, u && (e.mid = u.mid, e.merchid = e.merchid || u.merchid);
        var d = this;
    ...
    pay: function(t, n, o) {
        return "object" == (void 0 === t ? "undefined" : e(t)) && "function" == typeof n && (t.success = n, "function" == typeof o && (t.fail = o), void wx.requestPayment(t))
    },
    ...
    onShareAppMessage: function(t, e) {
        var n = getApp(),
            o = n.getCache("sysset"),
            i = o.share || {}, a = n.getCache("userinfo_id"),
            r = o.shopname || "",
            s = o.description || "";
        return i.title && (r = i.title), e && (r = e), i.desc && (s = i.desc), t = t || "/pages/index/index", t = -1 != t.indexOf("?") ? t + "&" : t + "?", {
            title: r,
            desc: s,
            path: t + "mid=" + a
        }
