...
t.requirejs("core"), Page({
    ...
    onLoad: function() {
        ...
        }), 5 == (new Date).getMonth() && (5 <= (new Date).getDate() && (new Date).getDate() <= 7 && (new Date).getHours() >= 10 ? this.setData({
            now: !0,
            activity_id: 2
    ...
    register: function(t) {
        var e = {};
        e.mobile = this.data.registertel, e.password = this.data.registerpass, e.confirm_password = this.data.confirmPassword, e.smscode = this.data.registersmscode, wx.login({
            success: function(t) {
    ...
    ratating: function(t) {
        var e = this,
            a = e.data.angle,
            s = e.data.rotateAngle,
            i = e.data.offOn,
            o = (e.data.halfAngle, e.data.radian, e.data.index),
            n = e.data.circle,
            r = null,
            c = this.pri2();
        o = c, clearInterval(r), r = setInterval(function() {
            s = n - o * a, e.setData({
                time: "4",
                rotateAngle: s
            }), clearInterval(r), setTimeout(function() {
                i = !i, e.setData({
                    sudokuShow: !0
                })
            }, 4e3)
    ...
    roll: function(t) {
        var e = this,
            a = this.data.times + 1,
            s = this.data.cycle,
            i = this.data.prizeIndex,
            o = this.data.sudokuIndex,
            n = this.data.timer,
            r = this.data.speed;
        if (this.data.count, e.setData({
            ...
            else if (a == s) var c = e.pri();
            else a > s + 10 && (0 == i && 7 == c || i == c + 1) ? e.setData({
                speed: r + 110
            }) : e.setData({
                speed: r + 20
            });
