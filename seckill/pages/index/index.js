...
Page({
    ...
    onLoad: function() {
        ...
        wx.getSystemInfo({
            ...
            1 == e.error ? t.setData({
                ...
                var i = {};
                "seckill_advs" == s.id && (i.adv_num = s.data.length), i.diypages = e.diypages, t.setData(i)
            }), t.setData({
                rooms: e.rooms,
    ...
    initTimer: function(e) {
        ...
        var r = parseInt(i.status),
            o = i.starttime,
            n = i.endtime;
        if (clearInterval(s.data.timer), -1 != r) {
            var d = 0,
                u = 0,
                l = t.globalData.approot;
            wx.request({
                url: l + "map.json",
                success: function(t) {
    ...
    formatSeconds: function(t) {
        var e = parseInt(t),
            a = 0,
            s = 0;
        return e > 60 && (a = parseInt(e / 60), e = parseInt(e % 60), a > 60 && (s = parseInt(a / 60), a = parseInt(a % 60))), {
            hour: s < 10 ? "0" + s : s,
            min: a < 10 ? "0" + a : a,
            sec: e < 10 ? "0" + e : e
        }
    ...
    play: function(t) {
        ...
        a.onPlay(function() {
            var t = setInterval(function() {
                var s = a.currentTime / a.duration * 100 + "%",
                    r = Math.floor(Math.ceil(a.currentTime) / 60),
        ...
        var r = t.currentTarget.dataset.audio,
            o = t.currentTarget.dataset.time,
            n = t.currentTarget.dataset.pausestop,
        ...
        var u = i.data.audios;
        u[e] || (u[e] = {}), a.paused && 0 == o ? (a.src = r, a.play(), 1 == d && (a.loop = !0), u[e].status = !0, i.pauseOther(e)) : a.paused && o > 0 ? (a.play(), 0 == n ? a.seek(o) : a.seek(0), u[e].status = !0, i.pauseOther(e)) : (a.pause(), u[e].status = !1), i.setData({
            audios: u
        })
    },
    ...
    tabwidget: function(t) {
        var a = this,
            s = a.data.diypages,
            i = (s.items, t.currentTarget.dataset.id),
            r = t.currentTarget.dataset.url,
            o = t.currentTarget.dataset.type;
        "" != r && void 0 != r && e.get("diypage/getInfo", {
            dataurl: r
        }, function(t) {
            for (var e in s.items) e == i && (s.items[e].data[o].data = t.goods.list, s.items[e].data[o].type = t.type, s.items[e].type = t.type, s.items[e].status = o, t.goods.list.length <= 8 && (s.items[e].data[o].showmore = !0), a.setData({
                diypages: s
            }))
        })
    }
