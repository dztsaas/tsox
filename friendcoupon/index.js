...
t.requirejs("jquery"), Page({
    ...
    getList: function() {
        ...
        i.get("friendcoupon", {
            ...
            if (0 == e.error) {
                if (e.currentActivityInfo && (e.currentActivityInfo.enough = Number(e.currentActivityInfo.enough)), "string" == typeof e.activitySetting.desc && t.setData({
                    isArray: !0
                }), t.setData({
