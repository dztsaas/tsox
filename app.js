...
App({
    ...
    getConfig: function() {
      if (null !== this.siteInfo.api) return {
        api: this.siteInfo.api,
        approot: this.siteInfo.approot,
        appid: this.siteInfo.appid
        };
        var e = wx.getExtConfigSync();
      return this.siteInfo.api = e.config.api, this.siteInfo.approot = e.config.approot, this.siteInfo.appid = e.config.appid, e.config
    },
    getCache: function(e, t) {
        ...
        a = parseInt(a);
        try {
          (i = wx.getStorageSync(e + this.siteInfo.appid)).expire > a || 0 == i.expire ? i = i.value : (i = "", this.removeCache(e))
        } catch (e) {
            i = void 0 === t ? "" : t
        }
        return i = i || ""
    ...
    setCache: function(e, t, a) {
        ...
        try {
          wx.setStorageSync(e + this.siteInfo.appid, o)
        } catch (e) {
            n = !1
        }
        return n
    ...
    removeCache: function(e) {
        var t = !0;
        try {
          wx.removeStorageSync(e + this.siteInfo.appid)
        } catch (e) {
            t = !1
        }
        return t
    ...
    url: function(e) {
        ...
        "" != n ? ("" != n.mid && void 0 !== n.mid || (t.mid = a), "" != n.merchid && void 0 !== n.merchid || (t.merchid = i)) : (t.mid = a, t.merchid = i), this.setCache("usermid", t)
    },
